...
typedef NS_ENUM(NSInteger, RequestType) {
    ...
    ReaciveOrder = 23,
    PropertyGrouping = 24,
    MaintenanceProcess = 25,
    ManList = 26,
    UploadHeadImage = 27,
    UserInfo = 28,
    LocationShop = 29,
    UpdateTime = 30,
    UserInfoForChatList = 31,
    FindPassword = 32,
    ChangePassWord = 33,
    UpdateHeadPic = 34,
    UpdateShopAddress = 35,
    ConfigInfo = 36,
    StartRepair = 37,
    Device_AvailableStatics = 38,
    Device_AvailableType = 39,
    InspectionPlanOverview = 40,
    Statistics_MTPlanList = 41,
    Statistics_EPList = 42,
    Statistics_DeviceTypeList = 43,
    Statistics_MTComplete = 44,
    Statistics_Complete = 45,
    Statistics_Subgroup = 46,
    Statistics_Faulttype = 47,
    Statistics_Workload_day = 48,
    Statistics_Workload_year = 49,
    Statistics_Workload = 50,
    Statistics_Praise = 51,
    SpecialOrderTypes = 52,
    Exit_Login = 53,
    Device_Con = 54,
    Device_Repair_List = 55,
    Inspection_Record_List = 56,
    Mail_Get_All = 57,
    Mail_User_list = 58,
    MaintenanceEquipmentList = 59,
    Add_Inspection = 60,
    Update_Inspection = 61,
    Ads_Pics = 62,
    Remind_Number = 63
};
