...
- (void)drawRect:(CGRect)rect
{
    ...
    CGFloat space = (SCREEN_WIDTH - x*2.f)/3.f;
    ...
    [self drawTextInRect:CGRectMake(x + space - 23.f, 62, 60.f, 20.f) Contents:@"维修中" contentFont:[UIFont systemFontOfSize:15.f] contentColor:colorWithHexString(@"909497")];
    [self drawTextInRect:CGRectMake(x + space * 2 - 23.f, 62, 60.f, 20.f) Contents:@"已完成" contentFont:[UIFont systemFontOfSize:15.f] contentColor:colorWithHexString(@"909497")];
    [self drawTextInRect:CGRectMake(x + space * 3 - 23.f, 62, 60.f, 20.f) Contents:@"已评价" contentFont:[UIFont systemFontOfSize:15.f] contentColor:colorWithHexString(@"909497")];
}
