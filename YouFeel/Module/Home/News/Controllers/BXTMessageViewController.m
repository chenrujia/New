...
@interface BXTMessageViewController ()<SegmentViewDelegate,UIScrollViewDelegate>
{
...
- (void)createSubviews
{
    ...
    segment = [[SegmentView alloc] initWithFrame:CGRectMake(10.f, 5.f, SCREEN_WIDTH - 20.f, 30.f) andTitles:@[@"未读",@"已读"] isWhiteBGColor:1];
    ...
    {
        BXTMessageView *messageView = [[BXTMessageView alloc] initWithFrame:CGRectMake((i - 1) * SCREEN_WIDTH, 0, SCREEN_WIDTH, CGRectGetHeight(currentScrollView.bounds)) eventType:[NSString stringWithFormat:@"%ld", (long)i]];
        [currentScrollView addSubview:messageView];
    }
}
