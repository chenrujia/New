...
- (void)viewDidLoad
{
    ...
    //如果日常工单和维保工单都不包含
    if (!([power containsString:@"10200"] || [power containsString:@"10301"]) && !([power containsString:@"30100"] || [power containsString:@"30201"]))
    {
        [self.imgNameArray removeObjectAtIndex:0];
        [self.titleNameArray removeObjectAtIndex:0];
    }
    //如果不包含维保工单
    else if (([power containsString:@"10200"] || [power containsString:@"10301"]) && !([power containsString:@"30100"] || [power containsString:@"30201"]))
    {
