...
#import "WorkloadCell.h"

@interface WorkloadViewController () <UITableViewDataSource, UITableViewDelegate, BXTDataResponseDelegate>
{
    CGFloat bgViewH;
    UIImageView *arrow;
}
...
- (void)createWorkIoadViewOfIndex:(NSInteger)index WithTableViewCell:(WorkloadCell *)newCell {
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WorkloadCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if (cell == nil) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"WorkloadCell" owner:nil options:nil] lastObject];
    ...
    cell.groupView.text = [NSString stringWithFormat:@"%@", dataDict[@"subgroup"]];
