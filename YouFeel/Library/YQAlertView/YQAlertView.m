...
- (void)layoutSubviews{
    ...
    CGFloat messageLabelY = CGRectGetMaxY(self.titleLabel.frame) + SPACE_LARGE - 5;
    ...
    if (self.buttonTitleArray.count > 0) {
        ...
        for (NSString *buttonTitle in _buttonTitleArray) {
            ...
            [button setTitleColor:[UIColor colorWithRed:0.22 green:0.51 blue:0.97 alpha:1.00] forState:UIControlStateNormal];
...
- (void)buttonWithPressed:(UIButton *)button{
    ...
    NSInteger selectedIndex = [_buttonTitleArray indexOfObject:button.titleLabel.text];
    if (selectedIndex == 0)
    {
