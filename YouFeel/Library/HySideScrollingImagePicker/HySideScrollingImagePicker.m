...
@interface HySideScrollingImagePicker ()<UICollectionViewDataSource,UICollectionViewDelegate,UIGestureRecognizerDelegate,MBProgressHUDDelegate>
...
//    collectionView.translatesAutoresizingMaskIntoConstraints = NO;
    ...
    _lib.GetImageBlock = ^(NSArray *ImgsData){
        ...
        if (weak.allArr.count > 50)
        {
            weak.allArr = (NSMutableArray *)[weak.allArr subarrayWithRange:NSMakeRange(0, 50)];
        }
